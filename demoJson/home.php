...
if(isset($_REQUEST['page'])){
    if($_REQUEST['page'] == 'delete'){
        ...
        header("http://localhost/demoJson/home.php");
    }
}
?>
<!DOCTYPE html>
...
<div class="container">
    <h2>Products List</h2>
    <a href="product/add_product.php" type="button" class="btn btn-outline-success mb-3 mt-3 btn-lg">ADD PRODUCT</a>
    ...
    <table class="table table-dark table-striped">
        ...
        <?php foreach ($result as $key=>$product): ?>
            <tr>
                ...
                <td><a href="product/editProduct.php?id=<?php echo $product->getId() ?>">Edit</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
